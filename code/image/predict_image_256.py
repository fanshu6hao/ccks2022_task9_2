...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_csv_name", type=str, default="pair_fea_list_image_256.csv")
    parser.add_argument("--pretrain_image_model_path", type=str, default="../../../pretrained_model/swin_large_patch4_window12_384_in22k")
    parser.add_argument("--image_model_name", type=str, default="baseline_image_large_256_23.pkl")
